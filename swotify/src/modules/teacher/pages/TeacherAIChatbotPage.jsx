...
const TeacherAIChatbotPage = () => {
    ...
    const starterSuggestions = [
        { text: "Analyze class performance", icon: "📊", desc: "Get insights on student grades" },
        { text: "Suggest teaching strategies", icon: "💡", desc: "Improve engagement methods" },
        { text: "Generate progress report", icon: "📄", desc: "Create student summaries" },
        { text: "Track attendance patterns", icon: "📅", desc: "Identify attendance trends" },
    ];

    const [threads] = useState([
        { id: 1, title: 'Class 10A Performance', date: 'Today' },
        { id: 2, title: 'Student Progress Report', date: 'Yesterday' },
        { id: 3, title: 'Homework Strategies', date: '3 days ago' },
    ]);
    ...
    const handleSendMessage = async () => {
        ...
        setTimeout(() => {
            const aiResponse = {
                sender: 'ai',
                text: `Based on your query about "${input}", here's my analysis:\n\n**Class Insights:**\n• Overall class average: 78%\n• Top performers: 5 students (90%+)\n• Students needing attention: 3 students (<60%)\n\n**Recommendations:**\n1. Consider group activities for collaborative learning\n2. Provide extra practice materials for struggling students\n3. Encourage peer tutoring among top performers\n\nWould you like me to create a detailed action plan?`,
                timestamp: new Date()
            };
        ...
        <div className="flex h-[calc(100vh-8rem)] gap-6">
            ...
            <div className="flex-1 flex flex-col bg-white rounded-xl border border-slate-200 overflow-hidden">
                <div className="px-6 py-4 border-b border-slate-200 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-slate-800">Teaching AI Assistant</h1>
                        <p className="text-sm text-slate-500">Get help with teaching and student analysis</p>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-slate-50">
                    {messages.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center">
                            ...
                            <p className="text-slate-500 text-sm mb-6">Ask me about class performance, teaching strategies, or student progress</p>
                ...
                <div className="p-4 border-t border-slate-200 bg-white">
                    <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 rounded-xl p-2 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100 transition-all max-w-3xl mx-auto">
                        ...
                        <button
                            ...
                            disabled={!input.trim()}
                            className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center transition-all ${input.trim() ? 'bg-[#ea580c] hover:bg-[#c2410c] text-white' : 'bg-slate-200 text-slate-400 cursor-not-allowed'}`}
                        >
...
export default TeacherAIChatbotPage;
