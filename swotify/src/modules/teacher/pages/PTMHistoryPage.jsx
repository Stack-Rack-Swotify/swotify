...
const PTMHistoryPage = () => {
  ...
  const getScoreColor = (score) => {
    ...
    if (numScore >= 90) return 'text-[#ff7300]';
    if (numScore >= 75) return 'text-[#9000ff]';
    return 'text-[#827979]';
  };

  // Get grade badge style
  const getGradeBadgeStyle = (grade) => {
    if (grade.startsWith('A')) return 'bg-gradient-to-r from-[#ff7300]/10 to-[#ff7300]/5 text-[#ff7300] border-[#ff7300]/20';
    if (grade.startsWith('B')) return 'bg-gradient-to-r from-[#9000ff]/10 to-[#9000ff]/5 text-[#9000ff] border-[#9000ff]/20';
    return 'bg-gradient-to-r from-[#827979]/10 to-[#827979]/5 text-[#827979] border-[#827979]/20';
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">PTM History</h1>
          <p className="text-[#827979] text-sm">Review past Parent-Teacher Meeting logs and student performance discussions</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6 hover:shadow-lg transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pl-10 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#ff7300]/50 focus:border-[#ff7300] transition-all duration-200 hover:border-[#ff7300]/50 text-gray-800 bg-white"
                  value={searchTerm}
            ...
            {/* Teacher Filter */}
            <div>
              <label htmlFor="teacher-filter" className="block text-sm font-medium text-[#827979] mb-2">
                Filter by Teacher
              </label>
              <div className="relative">
                <select
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6 flex items-center justify-between hover:shadow-lg transition-all duration-300">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#ff7300]/10 to-[#9000ff]/10 rounded-lg flex items-center justify-center">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-800">Meeting Records</h3>
              <p className="text-xs text-[#827979]">Total PTM sessions logged</p>
            </div>
          </div>
          ...
          {filteredPTMHistory.length > 0 ? (
            filteredPTMHistory.map((ptm) => (
              <div key={ptm.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300">
                {/* Header Section */}
                <div className="bg-gradient-to-r from-[#ff7300]/5 to-[#9000ff]/5 p-6 border-b border-gray-100">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-12 h-12 bg-gradient-to-br from-[#ff7300] to-[#9000ff] rounded-full flex items-center justify-center text-white font-bold text-lg">
                          {ptm.studentName.charAt(0)}
                        </div>
                        <div>
                          <h2 className="text-xl font-bold text-gray-800">{ptm.studentName}</h2>
                          <div className="flex items-center gap-3 text-sm text-[#827979]">
                    ...
                    <Link 
                      ...
                      className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-[#ff7300] to-[#9000ff] text-white font-semibold rounded-xl text-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                ...
                <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        {ptm.discussionPoints.map((point, index) => (
                          <div key={index} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            <div className="w-6 h-6 bg-[#ff7300]/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                              <svg className="w-3 h-3 text-[#ff7300]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {ptm.actionItems.map((item, index) => (
                            <div key={index} className="flex items-start gap-3 p-3 bg-gradient-to-br from-[#9000ff]/5 to-[#ff7300]/5 rounded-lg border border-[#9000ff]/20">
                              <div className="w-6 h-6 bg-[#9000ff]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                                <svg className="w-3 h-3 text-[#9000ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-gray-800 mb-3 flex items-center">
                      <span className="w-1 h-5 bg-gradient-to-b from-[#827979] to-[#9000ff] rounded-full mr-2"></span>
                      Performance Summary
                    </h3>
                    
                    <div className="bg-gradient-to-br from-gray-50 to-white p-5 rounded-xl border border-gray-200 space-y-4">
                      {/* Overall Grade Badge */}
                      <div className="flex items-center justify-between pb-4 border-b border-gray-200">
                        <span className="text-sm font-medium text-[#827979]">Overall Grade</span>
                      ...
                      <div className="space-y-3">
                        {ptm.performanceSummary.mathScore && (
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="w-8 h-8 bg-[#ff7300]/10 rounded-lg flex items-center justify-center">
                        ...
                        {ptm.performanceSummary.scienceScore && (
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="w-8 h-8 bg-[#9000ff]/10 rounded-lg flex items-center justify-center">
                        ...
                        {ptm.performanceSummary.historyScore && (
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="w-8 h-8 bg-[#827979]/10 rounded-lg flex items-center justify-center">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                          ...
                          <span className="text-base font-bold text-[#9000ff]">{ptm.performanceSummary.attendance}</span>
                        </div>
                      </div>

                      {/* Teacher Comment */}
                      <div className="pt-4 border-t border-gray-200">
                        <p className="text-xs font-semibold text-[#827979] mb-2 uppercase tracking-wide flex items-center gap-2">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">No PTM Records Found</h3>
              <p className="text-[#827979] max-w-md mx-auto">
