...
import PerformanceAnalysis from '../../student/components/PerformanceAnalysis';
            ...
            <div className="min-h-screen flex items-center justify-center p-6">
                <div className="section-card p-12 text-center max-w-md animate-fade-in">
                    <div className="relative mb-8">
                        <div className="absolute inset-0 bg-orange-500 rounded-full blur-xl opacity-20 animate-pulse-glow"></div>
                    ...
                    <p className="text-slate-500 font-medium mb-6">The student report you're looking for doesn't exist.</p>
                    <button
                        onClick={() => navigate(-1)}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-[#ea580c] text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 hover-lift"
                    >
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-gradient">Student Report</h1>
                        <p className="text-slate-500 text-sm">Viewing {student.name}'s academic report</p>
                    </div>
                </div>
            ...
            <div className="section-card overflow-hidden animate-slide-in-up">
                {/* Gradient Banner */}
                <div className="relative h-32 bg-[#ea580c]">
                    <div className="absolute inset-0 holographic opacity-50"></div>

                    {/* Action Buttons */}
                    <div className="absolute top-4 right-4 flex gap-3">
                        <button
                            onClick={() => navigate(`/teacher-dashboard/student-profile/${studentId}`)}
                            className="flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl font-semibold text-sm hover:bg-white/30 transition-all"
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
