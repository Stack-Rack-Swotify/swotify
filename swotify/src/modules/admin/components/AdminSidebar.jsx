...
const AdminSidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-30 ${isSidebarOpen ? 'w-72' : 'w-16'
      ...
      >
        {/* Logo Section */}
        <div className={`${isSidebarOpen ? 'h-20' : 'h-20'} flex items-center ${isSidebarOpen ? 'px-6' : 'justify-center'} border-b border-slate-200/60 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 flex-shrink-0 relative overflow-hidden`}>
          {isSidebarOpen ? (
              ...
              {({ isActive }) => (
                <>
                  ...
                  {isSidebarOpen && item.badge && (
                    <span className={`px-2 py-0.5 text-[10px] font-bold rounded-lg ${isActive
