      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300">
            ...
            <h3 className="text-2xl font-bold text-[#1e293b] mb-1">1,234</h3>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-semibold text-[#6366f1] bg-[#6366f1]/10 px-2 py-1 rounded-full">+5%</span>
            </div>
            <h3 className="text-2xl font-bold text-[#1e293b] mb-1">89</h3>
            <p className="text-sm text-[#64748b]">Staff Members</p>
          </div>

          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-[#a78bfa]/10 rounded-xl flex items-center justify-center">
              ...
              <span className="text-xs font-semibold text-[#8b5cf6] bg-[#8b5cf6]/10 px-2 py-1 rounded-full">32</span>
            </div>
            <h3 className="text-2xl font-bold text-[#1e293b] mb-1">45</h3>
            <p className="text-sm text-[#64748b]">Active Classes</p>
          </div>

          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-[#64748b]/10 rounded-xl flex items-center justify-center">
                <svg className="w-6 h-6 text-[#64748b]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <span className="text-xs font-semibold text-[#6366f1] bg-[#6366f1]/10 px-2 py-1 rounded-full">This Week</span>
            </div>
            <h3 className="text-2xl font-bold text-[#1e293b] mb-1">8</h3>
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ${isSidebarOpen ? 'lg:ml-72' : 'lg:ml-16'}`}>
        {/* Header */}
        <header className="sticky top-0 z-10 w-full p-4 bg-white/90 backdrop-blur-lg flex justify-between items-center border-b border-gray-200 shadow-sm">
          <button
            onClick={toggleSidebar}
            className="p-2 rounded-xl hover:bg-[#6366f1]/10 focus:outline-none focus:ring-2 focus:ring-[#6366f1]/50 transition-all duration-200 group"
          >
            <svg className="w-6 h-6 text-[#64748b] group-hover:text-[#6366f1] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative">
              <button
                ...
                className="relative p-2 rounded-xl hover:bg-[#6366f1]/10 focus:outline-none focus:ring-2 focus:ring-[#6366f1]/50 transition-all duration-200 group"
              >
                <svg className="w-6 h-6 text-[#64748b] group-hover:text-[#6366f1] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
                {unreadCount > 0 && (
                  <span className="absolute top-0 right-0 inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] rounded-full border-2 border-white">
                    {unreadCount}
                  </span>
                )}
              </button>
              {isNotificationOpen && (
                <div className="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-xl border border-gray-100 z-50 overflow-hidden">
                    ...
                    {notifications.map((notif) => (
                      <div 
                        ...
                        className={`px-4 py-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors cursor-pointer ${
                          notif.unread ? 'bg-[#6366f1]/5' : ''
                        }`}
                      >
                        <div className="flex items-start gap-3">
                          <div className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${notif.unread ? 'bg-[#6366f1]' : 'bg-gray-300'}`}></div>
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-semibold text-[#1e293b] mb-1">{notif.title}</p>
                  ...
                  <div className="px-4 py-3 bg-gray-50 text-center border-t border-gray-100">
                    <button className="text-sm font-medium text-[#6366f1] hover:text-[#8b5cf6] transition-colors">
            ...
            <button
              ...
              className="p-2 rounded-xl bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]/50 transition-all duration-200"
            ...
            <div className="relative">
              <button 
                ...
                className="flex items-center gap-2 p-1 rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#6366f1]/50 transition-all duration-200"
              >
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#6366f1] to-[#8b5cf6] p-0.5">
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 overflow-hidden">
                  <NavLink 
                    ...
                    className="flex items-center gap-3 px-4 py-3 text-sm text-[#1e293b] hover:bg-[#6366f1]/10 hover:text-[#6366f1] transition-all"
                  >
