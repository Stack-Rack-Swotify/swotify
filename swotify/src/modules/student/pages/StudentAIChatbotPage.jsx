        ...
        <div className="flex h-[calc(100vh-8rem)] gap-6">
            ...
            <div className="flex-1 flex flex-col bg-white rounded-xl border border-slate-200 overflow-hidden">
                            ...
                            <div className="grid grid-cols-2 gap-3 max-w-lg">
                                {starterSuggestions.map((item, index) => (
                                    <button
                                        ...
                                        className="text-left px-4 py-3 bg-white border border-slate-200 rounded-xl hover:border-[#ea580c] hover:shadow-md transition-all"
                                    >
                            ...
                            {messages.map((msg, index) => (
                                <div key={index} className={`flex gap-3 ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                                    ...
                                    <div className="max-w-xl">
                                        <div className={`rounded-xl px-4 py-3 ${msg.sender === 'user' ? 'bg-[#ea580c] text-white' : 'bg-white border border-slate-200 text-slate-800'}`}>
                ...
                <div className="p-4 border-t border-slate-200 bg-white">
                    <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 rounded-xl p-2 focus-within:border-[#ea580c] focus-within:ring-2 focus-within:ring-orange-100 transition-all max-w-3xl mx-auto">
                        <textarea
                            ref={inputRef}
                            rows={1}
