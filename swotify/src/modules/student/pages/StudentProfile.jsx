    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#827979] text-sm">View and manage your personal information</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6 hover:shadow-lg transition-all duration-300">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-40 h-40 rounded-full bg-gradient-to-br from-[#ff7300] to-[#9000ff] p-1">
                <img
                  src={student.photo}
                  alt={student.name}
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-[#827979] mb-4">{student.details.email}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gradient-to-br from-[#ff7300]/10 to-[#ff7300]/5 p-4 rounded-xl border border-[#ff7300]/20">
                  ...
                  <p className="text-base font-bold text-gray-800">{student.details.grade}</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#9000ff]/10 to-[#9000ff]/5 p-4 rounded-xl border border-[#9000ff]/20">
                  ...
                  <p className="text-base font-bold text-gray-800">{student.details.attendance}</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-[#827979]/10 to-[#827979]/5 p-4 rounded-xl border border-[#827979]/20">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-[#827979] uppercase tracking-wide">Parents</span>
                  </div>
                  <p className="text-base font-bold text-gray-800">{student.details.parents}</p>
                </div>

                <div className="bg-gradient-to-br from-[#ff7300]/10 via-[#9000ff]/5 to-[#827979]/5 p-4 rounded-xl border border-[#ff7300]/20">
                  <div className="flex items-center gap-2 mb-1">
                    <svg className="w-4 h-4 text-[#ff7300]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
                    </svg>
                    <span className="text-xs font-medium text-[#827979] uppercase tracking-wide">Student ID</span>
                  </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2 bg-gradient-to-r from-[#9000ff]/10 to-[#ff7300]/10 px-4 py-2 rounded-full border border-[#9000ff]/20">
              ...
              <span className="text-sm font-semibold text-[#9000ff]">Avg: {avgScore}%</span>
            </div>
          </div>
                    ...
                    <td className="py-4 px-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <span className={`text-sm font-bold ${
                          (exam.score / exam.maxScore * 100) >= 90 ? 'text-[#ff7300]' :
                          (exam.score / exam.maxScore * 100) >= 75 ? 'text-[#9000ff]' : 'text-[#827979]'
                        }`}>
                          {exam.score}/{exam.maxScore}
                        </span>
                        <span className={`text-xs px-2 py-1 rounded-full font-semibold ${
                          (exam.score / exam.maxScore * 100) >= 90 ? 'bg-[#ff7300]/10 text-[#ff7300] border border-[#ff7300]/20' :
                          (exam.score / exam.maxScore * 100) >= 75 ? 'bg-[#9000ff]/10 text-[#9000ff] border border-[#9000ff]/20' : 
