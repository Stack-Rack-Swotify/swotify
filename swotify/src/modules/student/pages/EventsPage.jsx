  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Premium Header */}
        <div className="mb-10">
          <h3 className="text-4xl font-semibold bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-3">Events & Meetings</h3>
        ...
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-8">
            <div className="relative">
              ...
              <div className="relative w-14 h-14 bg-gradient-to-br from-cyan-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-2xl">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                </svg>
              </div>
            </div>
            <h4 className="text-3xl font-semibold text-slate-900 dark:text-gray-100">School Events</h4>
          </div>
          ...
          {schoolEvents.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {schoolEvents.map((event) => (
                <Link 
                  to={`${event.id}`} 
                  key={event.id} 
                  className="group block bg-white/90 dark:bg-gray-800/90 backdrop-blur-2xl rounded-3xl shadow-xl border-2 border-slate-200/60 dark:border-gray-700/50 overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative"
                >
                  {/* Premium Event Image */}
                  {event.pictures && event.pictures.length > 0 && (
                    <div className="relative h-56 overflow-hidden">
                      ...
                      <div className="absolute top-5 right-5 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-5 py-2 rounded-full text-sm font-medium shadow-xl">
                        Event
                      </div>
                    </div>
                  )}
                  ...
                  <div className="p-6">
                    <h5 className="text-xl font-semibold text-slate-900 dark:text-gray-100 mb-4 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors line-clamp-2">
                      {event.title}
                    </h5>
                    
                    <div className="space-y-3 mb-4">
                      <div className="flex items-center gap-3 text-sm text-slate-700 dark:text-gray-300">
                        <div className="w-9 h-9 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center shadow-lg">
                      ...
                      <div className="flex items-center gap-3 text-sm text-slate-700 dark:text-gray-300">
                        <div className="w-9 h-9 bg-gradient-to-br from-orange-500 to-amber-500 rounded-lg flex items-center justify-center shadow-lg">
                          <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                    ...
                    <p className="text-sm text-slate-600 dark:text-gray-400 line-clamp-2 mb-5">{event.description}</p>
                    
                    <div className="flex items-center gap-3 text-cyan-600 dark:text-cyan-400 font-medium text-sm group-hover:gap-4 transition-all">
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-2xl rounded-3xl shadow-xl border-2 border-slate-200 dark:border-gray-700 p-16">
              <div className="flex flex-col items-center justify-center">
                <div className="relative w-24 h-24 mb-6">
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-3xl animate-pulse"></div>
                  <div className="relative w-full h-full bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-3xl flex items-center justify-center border-2 border-cyan-300 dark:border-cyan-700 shadow-xl">
                    <svg className="w-12 h-12 text-slate-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                </div>
                <p className="text-slate-600 dark:text-gray-400 text-lg">No school events scheduled at the moment.</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div>
          <div className="flex items-center gap-4 mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl blur opacity-50 animate-pulse"></div>
              <div className="relative w-14 h-14 bg-gradient-to-br from-emerald-600 to-teal-600 rounded-2xl flex items-center justify-center shadow-2xl">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
            </div>
            <h4 className="text-3xl font-semibold text-slate-900 dark:text-gray-100">PTM Meetings</h4>
          </div>
          ...
          {ptmMeetings.length > 0 ? (
                ...
                >
                  ...
                  {meeting.pictures && meeting.pictures.length > 0 && (
                    <div className="relative h-56 overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/40 to-transparent"></div>
                      <div className="absolute top-5 right-5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-5 py-2 rounded-full text-sm font-medium shadow-xl">
                        PTM
                      </div>
                    </div>
                  )}
                  ...
                  <div className="p-6">
                    <h5 className="text-xl font-semibold text-slate-900 dark:text-gray-100 mb-4 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors line-clamp-2">
                      {meeting.title}
                    </h5>
                    ...
                    <p className="text-sm text-slate-600 dark:text-gray-400 line-clamp-2 mb-5">{meeting.description}</p>
                    
                    <div className="flex items-center gap-3 text-emerald-600 dark:text-emerald-400 font-medium text-sm group-hover:gap-4 transition-all">
                      <span>View Details</span>
                      <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                      </svg>
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-2xl rounded-3xl shadow-xl border-2 border-slate-200 dark:border-gray-700 p-16">
              <div className="flex flex-col items-center justify-center">
                <div className="relative w-24 h-24 mb-6">
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-3xl animate-pulse"></div>
                  <div className="relative w-full h-full bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-3xl flex items-center justify-center border-2 border-emerald-300 dark:border-emerald-700 shadow-xl">
                    <svg className="w-12 h-12 text-slate-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                  </div>
                </div>
                <p className="text-slate-600 dark:text-gray-400 text-lg">No PTM meetings scheduled at the moment.</p>
              </div>
            </div>
          )}
        </div>
