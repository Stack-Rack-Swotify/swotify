            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                ...
                <button
                  ...
                  className={`relative w-12 h-6 rounded-full transition-colors ${notificationEnabled ? 'bg-blue-500' : 'bg-slate-300'}`}
                >
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                ...
                <button
                  ...
                  className={`relative w-12 h-6 rounded-full transition-colors ${emailUpdates ? 'bg-blue-500' : 'bg-slate-300'}`}
                >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                ...
                <button
                  ...
                  className={`relative w-12 h-6 rounded-full transition-colors ${autoSave ? 'bg-blue-500' : 'bg-slate-300'}`}
                >
