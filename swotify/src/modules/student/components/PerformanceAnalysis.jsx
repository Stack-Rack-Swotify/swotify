    ...
    <div className="p-4 bg-white rounded-xl shadow-lg transform hover:scale-105 hover:shadow-2xl transition-all duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-100 p-3 rounded-lg shadow-sm">
          <p className="text-sm font-medium text-blue-800">Overall Score</p>
          <p className="text-2xl font-bold text-blue-900">{dummyPerformanceData.overallScore}%</p>
        </div>
        <div className="bg-green-100 p-3 rounded-lg shadow-sm">
          <p className="text-sm font-medium text-green-800">Improvement (Last Month)</p>
          <p className="text-2xl font-bold text-green-900">+{dummyPerformanceData.lastMonthImprovement}%</p>
        </div>
        <div className="bg-indigo-100 p-3 rounded-lg shadow-sm">
          <p className="text-sm font-medium text-indigo-800">Strongest Subject</p>
          <p className="text-2xl font-bold text-indigo-900">{dummyPerformanceData.strongestSubject}</p>
        </div>
        <div className="bg-red-100 p-3 rounded-lg shadow-sm">
          <p className="text-sm font-medium text-red-800">Weakest Subject</p>
          <p className="text-2xl font-bold text-red-900">{dummyPerformanceData.weakestSubject}</p>
        </div>
        <div className="bg-yellow-100 p-3 rounded-lg shadow-sm">
          <p className="text-sm font-medium text-yellow-800">Attendance Rate</p>
          <p className="text-2xl font-bold text-yellow-900">{dummyPerformanceData.attendanceRate}%</p>
        </div>
      </div>

      {/* Subject-wise Performance Section */}
      <div className="mt-6 p-4 border border-gray-200 rounded-lg bg-white">
        <h4 className="text-xl font-bold text-gray-800 mb-3">Subject-wise Performance</h4>
        
        <div className="mb-4">
          <label htmlFor="subject-select" className="block text-md font-medium text-gray-700 mb-2">
            Select Subject:
          </label>
          <select
            id="subject-select"
