  ...
  return (
    <div className="group relative bg-white/90 backdrop-blur-2xl rounded-2xl shadow-xl border-2 border-slate-200/60 p-8 hover:shadow-2xl transition-all duration-300 overflow-hidden">
      ...
      <div className="relative mb-6">
        <div className="flex items-center gap-4 mb-3">
          <div className="relative">
            ...
            <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-[#ea580c] to-[#c2410c] flex items-center justify-center shadow-lg">
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
        {/* Overall Score */}
        <div className="group/card relative bg-gradient-to-br from-orange-50 to-orange-100 p-5 rounded-xl border-2 border-orange-200 hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 to-orange-500/10 opacity-0 group-hover/card:opacity-100 transition-opacity"></div>
          <div className="relative flex items-center justify-between mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-[#ea580c] to-[#c2410c] rounded-lg flex items-center justify-center shadow-lg group-hover/card:rotate-12 transition-transform">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
          ...
          <p className="relative text-4xl font-bold text-[#ea580c]">{overallScore}%</p>
        </div>

        {/* Strongest Subject */}
        <div className="group/card relative bg-gradient-to-br from-slate-50 to-slate-100 p-5 rounded-xl border-2 border-slate-200 hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-slate-500/10 to-slate-500/10 opacity-0 group-hover/card:opacity-100 transition-opacity"></div>
          <div className="relative flex items-center justify-between mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-[#334155] to-[#1e293b] rounded-lg flex items-center justify-center shadow-lg group-hover/card:rotate-12 transition-transform">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
          ...
          <p className="relative text-xl font-bold text-[#334155]">{strongestSubject}</p>
        </div>
      ...
      <div className="relative p-6 border-2 border-slate-200 rounded-2xl bg-gradient-to-br from-slate-50/50 via-white/50 to-slate-50/50 backdrop-blur-sm shadow-lg mb-6">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-1.5 h-8 bg-gradient-to-b from-[#ea580c] to-[#c2410c] rounded-full"></div>
        ...
        <div className="mb-6">
          <label htmlFor="subject-select" className="block text-sm font-semibold text-slate-700 mb-3 flex items-center gap-2">
            <svg className="w-5 h-5 text-[#ea580c]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
          ...
          <div className="relative">
            <select
              id="subject-select"
              className="w-full md:w-80 px-5 py-4 text-sm border-2 border-slate-200 focus:outline-none focus:ring-4 focus:ring-[#ea580c]/20 focus:border-[#ea580c] bg-white text-slate-900 rounded-xl transition-all duration-300 hover:border-orange-300 appearance-none cursor-pointer font-medium shadow-sm"
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-6 mb-6">
              <div>
                ...
                <div className="flex flex-wrap items-start gap-6">
                  <div className="p-4 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-300 shadow-lg">
                    <p className="text-xs text-slate-600 font-semibold mb-2">Current Score</p>
                    <p className="text-3xl font-bold text-[#ea580c]">{currentSubjectPerformance.score}%</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-600 font-semibold mb-3">Performance Trend</p>
                    <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border-2 shadow-lg ${currentSubjectPerformance.trend === 'up'
      ...
      <div className="relative p-6 border-2 border-slate-200 rounded-2xl bg-gradient-to-br from-orange-50/50 via-slate-50/50 to-slate-50/50 backdrop-blur-sm shadow-lg">
        <div className="flex items-start gap-4">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-[#ea580c] to-[#c2410c] rounded-xl blur opacity-50 animate-pulse"></div>
            <div className="relative w-14 h-14 bg-gradient-to-br from-[#ea580c] to-[#c2410c] rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
