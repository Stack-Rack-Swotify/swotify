  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 hover:shadow-lg transition-all duration-300">
      <div className="mb-6">
        ...
        <p className="text-[#64748B] text-sm">Your attendance record and statistics are summarized below</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-[#0EA5E9]/10 to-[#0EA5E9]/5 p-5 rounded-xl border border-[#0EA5E9]/20 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
          ...
          <p className="text-xs font-medium text-[#64748B] uppercase tracking-wide mb-1">Total Classes</p>
        ...
        <div className="bg-gradient-to-br from-[#22C55E]/10 to-[#22C55E]/5 p-5 rounded-xl border border-[#22C55E]/20 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
          ...
          <p className="text-xs font-medium text-[#64748B] uppercase tracking-wide mb-1">Attended Classes</p>
          <p className="text-3xl font-bold text-[#22C55E]">{dummyAttendance.attendedClasses}</p>
        </div>

        {/* Absent Classes */}
        <div className="bg-gradient-to-br from-[#E11D48]/10 to-[#E11D48]/5 p-5 rounded-xl border border-[#E11D48]/20 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between mb-3">
            <div className="w-12 h-12 bg-[#E11D48]/20 rounded-xl flex items-center justify-center">
              <svg className="w-6 h-6 text-[#E11D48]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
              </svg>
            </div>
          </div>
          <p className="text-xs font-medium text-[#64748B] uppercase tracking-wide mb-1">Absent Classes</p>
          <p className="text-3xl font-bold text-[#E11D48]">{dummyAttendance.absentClasses}</p>
        </div>

        {/* Attendance Percentage */}
        <div className="bg-gradient-to-br from-[#0EA5E9]/10 via-[#0F172A]/5 to-[#0EA5E9]/5 p-5 rounded-xl border border-[#0EA5E9]/20 hover:shadow-md transition-all duration-300 hover:-translate-y-1 lg:col-span-2">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs font-medium text-[#0EA5E9] bg-[#0EA5E9]/10 px-3 py-1 rounded-full border border-[#0EA5E9]/20">
                Current
              </span>
            </div>
          </div>
          <p className="text-xs font-medium text-[#64748B] uppercase tracking-wide mb-1">Attendance Percentage</p>
          <div className="flex items-end gap-3">
            <p className="text-4xl font-bold text-[#0EA5E9]">{dummyAttendance.attendancePercentage}%</p>
        ...
        <div className="bg-gradient-to-br from-[#0F172A]/10 to-[#64748B]/5 p-5 rounded-xl border border-[#0F172A]/20 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between mb-3">
            <div className="w-12 h-12 bg-[#0F172A]/20 rounded-xl flex items-center justify-center">
          ...
          <p className="text-xs font-medium text-[#64748B] uppercase tracking-wide mb-1">Last Month</p>
          <p className="text-3xl font-bold text-[#0F172A]">{dummyAttendance.lastMonthPercentage}%</p>
        </div>
      </div>
      ...
      <div className="mt-6 p-6 border border-gray-100 rounded-xl bg-gradient-to-br from-gray-50 to-white">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 bg-gradient-to-br from-[#0EA5E9]/10 to-[#0F172A]/10 rounded-xl flex items-center justify-center flex-shrink-0">
            <svg className="w-6 h-6 text-[#0EA5E9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
          </div>
          <div className="flex-1">
            <h4 className="text-base font-semibold text-[#0F172A] mb-2">Attendance Summary</h4>
            ...
            {dummyAttendance.attendancePercentage >= 90 ? (
              <div className="flex items-center gap-2 text-[#22C55E] bg-[#22C55E]/10 px-3 py-2 rounded-lg inline-flex border border-[#22C55E]/20">
              ...
              <div className="flex items-center gap-2 text-[#F97316] bg-[#F97316]/10 px-3 py-2 rounded-lg inline-flex border border-[#F97316]/20">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2 text-[#E11D48] bg-[#E11D48]/10 px-3 py-2 rounded-lg inline-flex border border-[#E11D48]/20">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
