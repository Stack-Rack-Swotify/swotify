...
const AIChatbot = () => {
  return (
    <div className="p-4 bg-white rounded-xl shadow-lg h-full flex flex-col"> {/* Added h-full and flex-col */}
      ...
      <div className="flex">
        <input
          ...
          className="flex-1 px-4 py-2 rounded-l-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-500"
        />
