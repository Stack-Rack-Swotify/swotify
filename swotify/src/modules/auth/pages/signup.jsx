            ...
            <form className="space-y-3.5" onSubmit={handleSubmit}>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`w-full px-3 py-2 sm:py-2.5 text-sm rounded-lg border ${isDropdownOpen ? 'border-[#6366f1] ring-2 ring-[#6366f1]/20' : 'border-gray-300'
                  ...
                  <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl max-h-48 overflow-y-auto">
                    {roles.map((role) => (
                      <button
                        ...
                        className={`w-full px-3 py-2.5 text-sm text-left hover:bg-[#6366f1]/5 transition-colors flex items-center justify-between ${selectedRole === role.value ? 'bg-[#6366f1]/10' : ''
                          }`}
                      >
