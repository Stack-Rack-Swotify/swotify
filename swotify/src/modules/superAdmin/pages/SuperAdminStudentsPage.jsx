...
const SuperAdminStudentsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-white p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#0F172A] mb-2">Super Admin Student Management</h1>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6 hover:shadow-lg transition-all duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Section Dropdown */}
          <div>
            <label htmlFor="section-select" className="block text-sm font-semibold text-[#0F172A] mb-2 flex items-center gap-2">
