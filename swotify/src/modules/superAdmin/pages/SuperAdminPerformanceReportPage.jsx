...
const SuperAdminPerformanceReportPage = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-[#0F172A] mb-2">Super Admin Performance Report</h1>
...
export default SuperAdminPerformanceReportPage;
